...
public class Activation_Generalized_ReLU extends Activation_Generalized {
     ...
     * @param c
     */
    public Activation_Generalized_ReLU(VDouble k, VDouble s, VDouble c) {
        super(k);
        this.s = s;
        this.c = c;
    }
    ...
    public Activation_Function copy() {
        return new Activation_Generalized_ReLU((VDouble) getK().copy(), (VDouble) s.copy(), (VDouble) c.copy());
    }
