 ...
 * @author Oscar Lao
 */
public class Activation_Generalized_COS extends Activation_Generalized {
     ...
     * @param c
     */
    public Activation_Generalized_COS(VDouble k, VDouble s, VDouble c) {
        super(k);
        this.s = s;
        this.c = c;
    }
     ...
     */
    public Activation_Generalized_COS() {
        super();
...
//        act = 0.001*(0.5*0.1*act/(1+0.1*Math.abs(act))+0.5);
        return getK().getI().getD() * Math.cos(act);
...
//        return act;        
    ...
    public Activation_Function copy() {
        return new Activation_Generalized_COS((VDouble) getK().copy(), (VDouble) s.copy(), (VDouble) c.copy());
    }
