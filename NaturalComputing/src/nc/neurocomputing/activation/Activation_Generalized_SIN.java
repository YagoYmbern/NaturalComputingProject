 ...
 * @author Oscar Lao
 */
public class Activation_Generalized_SIN extends Activation_Generalized{
     ...
     * @param c
     */
    public Activation_Generalized_SIN(VDouble k, VDouble s, VDouble c) {
       super(k);
        this.s = s;
        this.c = c;
    }
     ...
     */
    public Activation_Generalized_SIN() {
        super();
        this.s = new GeneratorVDoubleGaussian(new NStepSizeSelfAdaptation(1, 0.01, 0.01), 1, 0.5).generateVariable();
        this.c = new GeneratorVDoubleGaussian(new NStepSizeSelfAdaptation(1, 0.01, 0.01), 1, 0.5).generateVariable();
    }
    ...
    public double activate(double v) {
        ...
        return getK().getI().getD() *Math.sin(act);             
    }

    @Override
    public Activation_Function copy() {
        return new Activation_Generalized_SIN((VDouble) getK().copy(), (VDouble) s.copy(), (VDouble) c.copy());
    }
